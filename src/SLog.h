...
class SLog {
  public:
	...
	// Timestamp cache
	static time_t cachedSecond;
	static struct tm cachedTm;
	static char cachedTimeStr[32];   // YYYY-MM-DDTHH:MM:SS
	static char cachedTzStr[8];       // +HH:MM
